...
class $NestedRouter {
  ...
  @initial
  RedColorPageView redColorPageViewRoute;

  GreenColorPageView greenColorPageViewRoute;

  BlueColorPageView blueColorPageViewRoute;

  YellowColorPageView yellowColorPageViewRoute;

  OrangeColorPageView orangeColorPageViewRoute;
}