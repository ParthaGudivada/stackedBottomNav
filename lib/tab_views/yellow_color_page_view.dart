...
import 'package:stackedBottomNav/tab_views/yellow_color_page_view_model.dart';
...
class YellowColorPageView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // return Text('Red');
    return ViewModelBuilder<YellowColorPageViewModel>.reactive(
      ...
      viewModelBuilder: () => YellowColorPageViewModel(),
    );
  }
}
