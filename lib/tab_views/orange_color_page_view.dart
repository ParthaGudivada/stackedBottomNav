...
import 'package:stackedBottomNav/tab_views/orange_color_page_view_model.dart';
...
class OrangeColorPageView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // return Text('Red');
    return ViewModelBuilder<OrangeColorPageViewModel>.reactive(
      ...
      viewModelBuilder: () => OrangeColorPageViewModel(),
    );
  }
}
